...
MODEL_NAME = "sambus211/zhaw_at_touche_setup10"
DEFAULT_TAG = "zhawAtToucheSetup10"
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Run the setup10 TIRA submission on a TIRA dataset id or local input directory."
    )
    parser.add_argument(
        "--dataset",
        default=None,
